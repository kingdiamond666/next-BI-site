          ...
          <div className="lg:col-start-2 lg:pl-8">
            <div className="text-base max-w-prose mx-auto lg:max-w-lg lg:ml-auto lg:mr-0">
              ...
              <p className="mt-8 text-lg text-gray-500">
                  Each business's needs are different and each solution custom. We take on each client with a carefully curated vetting process.
                  We launch data centers catered to each businesses needs.
              </p>
