...
export default function HomePageBanner({content, menuItems}) {
    const [growthMessage, setGrowthMessage] = useState('grow');
    const buttonOne = content.button[0]
    const buttonTwo = content.button[1]
    const {sub_desc_first, sub_desc_last, sub_desc_highlight} = content;
        ...
        <main className="mt-16 mx-auto max-w-7xl px-4 sm:mt-24">
          <div className="text-center">
            <h1 className="text-4xl tracking-tight font-extrabold text-gray-900 sm:text-5xl md:text-6xl">
              <span className="block xl:inline">Data to <TextLoop springConfig={{ stiffness: 180, damping: 8 }}>
            ...
            <p className="mt-3 max-w-md mx-auto text-base text-gray-500 sm:text-lg md:mt-5 md:text-xl md:max-w-3xl">
              {sub_desc_first} <span className="text-indigo-600 xl:inline">{sub_desc_highlight} </span> {sub_desc_last}.
            </p>
